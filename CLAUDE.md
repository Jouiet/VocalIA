...
*Last update: 01/03/2026 — Session 250.257: Plugin System Complete. 6 ZIPs (added Magento+OpenCart). CDN URL fix verified (0 api.vocalia.ma). Widget install verifier + heartbeat. install-widget.html upgraded (3 new CMS cards + verification UI). 12 CMS integrations fully covered.*
