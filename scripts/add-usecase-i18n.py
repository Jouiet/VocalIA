...
def add_i18n_to_support():
    ...
    replacements = [
        ...
        ("<p class=\"text-slate-400\">Choisissez parmi 30 personas métier ou créez le vôtre. Définissez le ton, les règles d'escalade.</p>", '<p class="text-slate-400" data-i18n="usecases_support_page.workflow_step2_desc">Choisissez parmi 30 personas métier ou créez le vôtre. Définissez le ton, les règles d\'escalade.</p>'),
