...
// Test data paths
const SAMPLE_MENU = path.join(__dirname, '../../data/catalogs/sample-restaurant-menu.json');
const SAMPLE_PRODUCTS = path.join(__dirname, '../../data/catalogs/sample-ecommerce-products.json');
const SAMPLE_SERVICES = path.join(__dirname, '../../data/catalogs/sample-garage-services.json');
const SAMPLE_FLEET = path.join(__dirname, '../../data/catalogs/sample-car-rental.json');
const SAMPLE_TRIPS = path.join(__dirname, '../../data/catalogs/sample-travel-trips.json');
