 ...
 *
 * Run: node --test test/audit-store.test.cjs
 */
...
const { AuditStore, ACTION_CATEGORIES } = require('../core/audit-store.cjs');

const TEST_DIR = path.join(__dirname, '../data/audit/__test__');
