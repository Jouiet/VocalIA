...
import { VoicePersonaInjector, PERSONAS } from '../personas/voice-persona-injector.cjs';
import fs from 'fs';
...
async function runTests() {
  ...
  try {
    const code = fs.readFileSync(path.join(import.meta.dirname, '../personas/voice-persona-injector.cjs'), 'utf8');
