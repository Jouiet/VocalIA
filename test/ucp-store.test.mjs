 ...
 * - Search and insights
 *
 * Run: node --test test/ucp-store.test.mjs
 */
...
import { UCPStore, getLTVTier, LTV_TIERS } from '../core/ucp-store.cjs';

const TEST_DIR = path.join(import.meta.dirname, '../data/ucp/__test__');
