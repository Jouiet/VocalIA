 ...
 *
 * Run: node --test test/product-embedding-service.test.cjs
 */

const { test, describe } = require('node:test');
const assert = require('node:assert');

const productEmbeddingService = require('../core/product-embedding-service.cjs');
...
describe('ProductEmbeddingService exports', () => {
  test('default export is ProductEmbeddingService instance', () => {
    assert.ok(productEmbeddingService instanceof ProductEmbeddingService);
  });

  test('exports ProductEmbeddingService class', () => {
    assert.strictEqual(typeof ProductEmbeddingService, 'function');
  });

  test('exports EMBEDDING_DIM constant', () => {
    assert.strictEqual(typeof EMBEDDING_DIM, 'number');
  });

  test('singleton has cosineSimilarity method', () => {
    assert.strictEqual(typeof productEmbeddingService.cosineSimilarity, 'function');
  });

  test('singleton has getProductEmbedding method', () => {
    assert.strictEqual(typeof productEmbeddingService.getProductEmbedding, 'function');
  });

  test('singleton has batchEmbed method', () => {
    assert.strictEqual(typeof productEmbeddingService.batchEmbed, 'function');
  });

  test('singleton has getQueryEmbedding method', () => {
    assert.strictEqual(typeof productEmbeddingService.getQueryEmbedding, 'function');
  });

  test('singleton has getCachedEmbedding method', () => {
    assert.strictEqual(typeof productEmbeddingService.getCachedEmbedding, 'function');
  });

  test('singleton has getAllEmbeddings method', () => {
    assert.strictEqual(typeof productEmbeddingService.getAllEmbeddings, 'function');
  });

  test('singleton has clearCache method', () => {
    assert.strictEqual(typeof productEmbeddingService.clearCache, 'function');
  });

  test('singleton has getStats method', () => {
    assert.strictEqual(typeof productEmbeddingService.getStats, 'function');
  });

  test('singleton has _generateProductText method', () => {
    assert.strictEqual(typeof productEmbeddingService._generateProductText, 'function');
  });

  test('singleton has _getPriceRange method', () => {
    assert.strictEqual(typeof productEmbeddingService._getPriceRange, 'function');
  });

  test('singleton has _getCachePath method', () => {
    assert.strictEqual(typeof productEmbeddingService._getCachePath, 'function');
  });

  test('singleton has _loadCache method', () => {
    assert.strictEqual(typeof productEmbeddingService._loadCache, 'function');
  });

  test('singleton has _saveCache method', () => {
    assert.strictEqual(typeof productEmbeddingService._saveCache, 'function');
  });
});
